...
<cfinvoke component="#DTS#" 
	...
	componentpath="mxunit-cfmeetups.MarcMXUnitIntro.tests"><!---  <-- Fill this in! This is the root component path for your tests. if your tests are at {webroot}/app1/test, then your componentpath will be app1.test   --->
