<cfcomponent>
	...
	<cfset variables.t = "http://www.twitter.com">
	...
	<cffunction name="test" hint="runs the twitter api test command.">
		<cfhttp url="#t#/help/test.json" method="get">
		<cfreturn cfhttp.FileContent>
	</cffunction>
	
		
	<cffunction name="myTimeline" hint="returns the authenticated user's timeline">
		<cfhttp url="#t#/statuses/user_timeline/#getUsername()#.#getFormat()#" method="get">
	...
	<cffunction name="friendsTimeline" hint="returns the authenticated user's friends timeline">
		<cfhttp url="#t#/statuses/friends_timeline.#getFormat()#" method="get" username="#getUsername()#" password="#getPassword()#">
		<cfreturn tweetsToStruct(cfhttp.FileContent)>
	</cffunction>
