<cfcomponent extends="mxunit.framework.TestCase">
	...
	* Does it call delete on those old files?
	...
	<cffunction name="getMarkedFilesForDeletionShouldReturnOnlyOldFiles">		
		...
		<!--- make getMarkedFilesForDeletion public so we can test it --->
		<cfset makePublic(fsm,"getMarkedFilesForDeletion")>
		
		<cfset all = fsm.getMarkedFilesForDeletion("c:\files\",targetTime)>
