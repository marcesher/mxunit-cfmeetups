<cfcomponent extends="mxunit.framework.TestCase">
	...
	<cfset gen = createObject("component","docs.global.components.PDFThumbnailGenerator")>
	
	
	<cffunction name="setUp" returntype="void" access="public" hint="put things here that you want to run before each test">
	
		<cfset onepage = request.sourcefilepath & "onepage.pdf">
		<cfset twopage = request.sourcefilepath & "letter.pdf">
		<cfset weirdname = request.sourcefilepath & "one.pdf_hmmm.pdf">
		<cfset twentypage = request.sourcefilepath & "20pages.pdf">
		<cfset asynch = request.sourcefilepath & "20pages.pdf">	
		<cfset image = request.sourcefilepath & "max logo.tif">
		
		<cfset newdir = request.sourcefilepath & createUUID()>
